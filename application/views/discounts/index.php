          ...
          <div class="box-body">
            ...
            <div id="add_item">
              <?php if (in_array('createDiscount', $user_permission)) : ?>
                <a href="<?php echo base_url('discounts/create') ?>" class="btn btn-primary btn.btn-flat ">+ New Discount</a>
                <br /> <br />
              <?php endif; ?>
            </div>
...
<?php if (in_array('deleteDiscount', $user_permission)) : ?>
  <!-- remove brand modal -->
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('discounts/remove') ?>" method="post" id="removeForm">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    manageTable = $('#manageTable').DataTable({
      ...
      'ajax': base_url + 'discounts/fetchDiscountsData',
      'order': []
    });
