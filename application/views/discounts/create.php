        ...
        <div class="row">
            <div class=" col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="box-header-over">
                    ...
                    <!-- /.box-header -->
                    <form role="form" onsubmit="return to_submit();" action="<?php base_url('discounts/create') ?>" method="post" class="form-horizontal">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="home">
                                        ...
                                        <div class="row padding-row">
                                            <div class=" col-xs-12 col-sm-4 col-lg-6">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Discount Name" autocomplete="off" maxlength="64">
                                            </div>
                                            ...
                                            <div class=" col-xs-6 col-sm-4 col-lg-3">
                                                <a>End Date</a>
                                                <input type="date" class="form-control" id="end_date" name="end_date" placeholder="End Date" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row padding-row">
                                            <div class=" col-xs-12 col-sm-4 col-lg-2">
                                                ...
                                                <input type="text" onkeypress=validateNumber(event); class="form-control" id="band_start" name="band_start" placeholder="Min. Amount" autocomplete="off">
                                            </div>
                                            <div class=" col-xs-6 col-sm-4 col-lg-2">
                                                <a for=" tax_id">Max. Amount</a>
                                                <input type="text" onkeypress=validateNumber(event); class="form-control" id="band_end" name="band_end" placeholder="Max. Amount" autocomplete="off">
                                            </div>
                                            ...
                                            <div class=" col-xs-6 col-sm-8 col-lg-2">
                                                <a>Amount</a>
                                                <input type="text" onkeypress=validateNumber(event); class="form-control" id="amount" name="amount" placeholder="Amount" autocomplete="off">
                                            </div>
                                            <div class=" col-xs-6 col-sm-4 col-lg-2">
                                                <a for="brands">Priority</a><br>
                                                <select class="form-control select_group" id="priority" name="priority_id">
                                                    <?php foreach ($type_prioritis as $k => $v) : ?>
                                    ...
                                    <table id="docTable" class="table table-bordered ">
                                        <thead>
                                            <tr class="row">
                                                ...
                                                <th class="hidden-xs col-xs-12 col-sm-5 col-lg-8">Product Name</th>
