    ...
    <section class="content">
        ...
        <div class="row">
              <div class=" col-xs-12 col-sm-12 col-lg-10">
                ...
                <div class="box option-name">
                    <div class="box-body">
                        <h4>Option name: <?php echo $attribute_data['name']; ?></h4>
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="box-header" id='box-header'>
                        <h3 class="box-title">Add Option Value</h3>
                    </div>
                    <div id="add_item">
            ...
            <form role="form" action="<?php echo base_url('attributes/updateValue') ?>" method="post" id="updateForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edit_attribute_value_name"
                            name="edit_attribute_value_name" placeholder="Enter attribute value" autocomplete="off">
                    </div>
                </div>
        ...
        .serialize(), // /converting the form data into array and sending it to server
            ...
            success: function(response) {
                ...
                if (response.success === true) {
                    ...
                    // reset the form
                    $("#createForm")[0].reset();
                    $("#createForm .form-group").removeClass('has-error').removeClass(
                        'has-success');
                ...
                .serialize(), // /converting the form data into array and sending it to server
                    ...
                    success: function(response) {
                        ...
                        if (response.success === true) {
                            ...
                            // reset the form 
                            $("#updateForm .form-group").removeClass('has-error')
                                .removeClass('has-success');
