    ...
    <div class="row">
      <div class=" col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="box-header-over ">
          ...
          <!-- /.box-header -->
          <form role="form" onsubmit="return to_submit();" action="<?php base_url('products/update') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class=" row product info ">
                  <div class="col-xs-12 col-sm-12 col-lg-8">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="product_name" value="<?php echo $product_data['name']; ?>" name="product_name" placeholder="Enter product name" autocomplete="off" />
                    </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-lg-3 ">
                        ...
                        <select class="form-control select_group" id="status_publish" name="status_publish">
                          <?php foreach ($statuses as $k => $v) : ?>
                            <option value="<?php echo $k ?>" <?php if ($product_data['status_publish'] == $k) {
                                                                      echo "selected='selected'";
                                                                    } ?>><?php echo $v ?>
                            </option>
                          <?php endforeach ?>
                ...
                <div class="dashed-line ">
                  ...
                  <div class="block-item">
                    <div class="table-white">
                      ...
                      <a id="add_row_opton" onClick="show_message_error('Need to record before ADD New VALUE')" class="btn btn-primary-form">+ ADD New VALUE</a>
                    </div>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  var product_name = "<?php echo $product_data['name']; ?>"
  var docTable;
  var listAllOptions;
  var row_id = 0;
  var idx = 0;
  ...
  function showModalPicture(id_picture, path_picture, name_product) {
    var html = '';
