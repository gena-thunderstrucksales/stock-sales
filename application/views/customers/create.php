  ...
  <section class="content">
    ...
    <div class="row">
      <div class=" col-xs-12 col-sm-12 col-lg-12">
        ...
        <form role="form" onsubmit="return to_submit();" action="<?php base_url('customers/create') ?>" method="post">
              ...
              <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-3 col-lg-2">
                    ...
                    <select class="form-control select_group" id="user_id" name="user_id" required onchange="onChangeUser()">
                      <?php foreach ($users as $k => $v) : ?>
                        <option value="<?php echo $v['id'] ?>" <?php if ($user_id == $v['id']) {
                ...
                <div class="row padding-row">
                  ...
                  <div class="col-xs-6 col-sm-4 col-lg-2 ">
                    <a>Phone No.</a>
                    <input type="text" class="form-control" id="phone_number" onkeypress="validateNumber(event);" name="phone_number" placeholder="Phone number" autocomplete="off" maxlength="64">
                  </div>
                </div>
