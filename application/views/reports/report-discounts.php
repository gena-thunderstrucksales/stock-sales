    ...
    <div class="row">
      ...
      <div class=" col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="box-header-over">
          ...
          <h4>SETTINGS</h4>
          <form class="form" action="<?php echo base_url('ReportDiscounts/generateReport') ?>" method="POST">
              ...
              <div class="box-body">
                ...
                <div class="row padding-row">
                  ...
                  <div class="col-xs-6 col-sm-6 col-lg-3">
                    <a for="brands">Priority</a>
                    <select class="form-control select_group" id="priority_id" name="priority_id">
                      <?php foreach ($type_prioritis as $k => $v) : ?>
                        <option value="<?php echo $v ?>" <?php echo $v ?> <?php if ($data_filter['priority_id'] == $k) {
                                                                            echo "selected='selected'";
                                                                          } ?>><?php echo $v ?></option>
                      <?php endforeach ?>
                    </select>
                ...
                ?>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class=''><?php echo $c['discount_id']; ?></td>
