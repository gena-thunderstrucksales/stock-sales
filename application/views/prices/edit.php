    ...
    <section class="content">
        ...
        <div class=" col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="box-header-over ">
                ...
                <form role="form" onsubmit="return to_submit();" action="<?php base_url('prices/update') ?>" method="post" class="form-horizontal">
                    <!-- /.box-header -->
                    <div class="main-box-body">
                        <div class="box-body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="home">
                                    ...
                                    <div class="row padding-row ">
                                        <div class="col-xs-6 col-sm-4 col-lg-4">
                                            <a>Date</a>
                                            <input type="text" class="form-control" disabled id="doc_date" name="doc_date[]" placeholder="Data" autocomplete="off" value="<?php echo $price_header['doc_date']; ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-4 col-lg-4">
                                            <a>Time</a>
                                            <input type="text" class="form-control" disabled id="doc_time" name="doc_time[]" placeholder="Time" autocomplete="off" value="<?php echo $price_header['doc_time']; ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-4 col-lg-4">
                                            <a>Number</a>
                                            <input type="text" class="form-control" disabled id="doc_number" name="doc_number[]" placeholder="0000000" autocomplete="off" value="<?php echo $price_header['id']; ?>">
                                        </div>
                                    </div>
                                    <input type="hidden" class="form-control" id="doc_date_doc_time" name="doc_date_doc_time" value="<?php echo $price_header['doc_date_doc_time']; ?>" autocomplete="off">
                                    <div class="row padding-row ">
                                        <div class=" col-xs-12 col-sm-4 col-lg-8">
                                            <a for=" customername">Price Name</a>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Price Name" autocomplete="off" maxlength="64" value="<?php echo $price_header['name']; ?>">
                                        </div>
                                        <div class="col-xs-4 col-sm-4 col-lg-4">
                                            ...
                                            <select class="form-control select_group" id="currency_id" name="currency_id" required>
                                                ...
                                                <?php foreach ($currencies as $k => $v) : ?>
                                                    <option value="<?php echo $v['id'] ?>" <?php if ($price_header['currency_id'] == $v['id']) {
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile">
                                    ...
                                    <div class="row padding-row ">
                                        <div class="col-xs-12 col-sm-12 col-lg-2 group-selection padding-row">
                                            <a>Category</a>
                                        ...
                                        <div class="col-xs-7 col-sm-7 col-lg-10">
                                            <br>
                                    ...
                                    <div class="row padding-row ">
                                        <div class="col-xs-12 col-sm-5 col-lg-5 padding-row">
                                        ...
                                        <?php if (isset($list_products['data'])) : ?>
                                            ...
                                            <?php foreach ($list_products['data'] as $key => $val) : ?>
                                                ...
                                                <tr class="row" id="row_<?php echo $x; ?>">
                                                    ...
                                                    <td class="">
                                                        <a class="visible-xs">Price</a>
                                                        <input id="price<?php echo $x ?>" type="number" min="0" step="0.01" onkeypress="validateNumber(event);" class="form-control " name="price[]" step="0.01" value="<?php echo $val['price'] ?>">
                        ...
                        <a>User name</a><br>
                        <?php echo $price_header['username'] ?>
                        <!-- /.Select table -->
                    </div>
