                ...
                <div class="col-xs-12 col-sm-6 col-lg-8">
                    ...
                    <select class="form-control select_group" id="order_id" name="order_id" onchange="getInfoOrder()">
                      ...
                      <?php foreach ($list_orders as $k => $v) : ?>
                        <option value="<?php echo $v['id'] ?>"><?php echo 'N-' . $v['id'] . ' from ' .  date('d-m-Y h:i a', $v['date_time']) . ' amount: ' . $v['total_order'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-lg-4">
                    <a>Amount</a>
                    <input type="text" onkeypress=validateNumber(event); class="form-control" id="total_payment" name="total_payment" placeholder="0.00" autocomplete="off">
                  </div>
                </div>
              </div>
              <a>User name</a><br>
